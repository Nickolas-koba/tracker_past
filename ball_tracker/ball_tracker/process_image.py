...
def create_tuning_window(initial_values):
    ...
    cv2.createTrackbar("x_min","Tuning",initial_values['x_min'],0,no_op)
    cv2.createTrackbar("x_max","Tuning",initial_values['x_max'],100,no_op)
    cv2.createTrackbar("y_min","Tuning",initial_values['y_min'],37,no_op)
    cv2.createTrackbar("y_max","Tuning",initial_values['y_max'],100,no_op)
    cv2.createTrackbar("h_min","Tuning",initial_values['h_min'],0,no_op)
    cv2.createTrackbar("h_max","Tuning",initial_values['h_max'],10,no_op)
    cv2.createTrackbar("s_min","Tuning",initial_values['s_min'],0,no_op)
    ...
    cv2.createTrackbar("sz_min","Tuning",initial_values['sz_min'],0,no_op)
